...
105     FORMAT(25X,A10,' NETWORK TICKETS',/25X,'-------------------',
     1  '-------',/)
        TYPE 110
110     FORMAT(/5X'THE FOLG UPPER CASE COMMANDS ARE ALSO ',
...
113     CALL DBERR($118,IERT,IERC,IBF)
        GOTO 116
...
25      FORMAT(A5)
        ...
        IF (J.EQ.'1') CCC=1
28      CALL DBERR($26,IERT,IERC,IBF)
        GOTO 27
